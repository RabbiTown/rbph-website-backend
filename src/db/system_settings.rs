...
pub async fn get(pool: &DbPool) -> Result<SystemSettings, RbInternalError> {
    Ok(sqlx::query_as!(
        ...
        "SELECT registration_open, require_email_verification,
            ...
            footer_additional_info, no_game_message, maintenance_enabled, maintenance_message,
...
pub async fn update(
    ...
    Ok(sqlx::query_as!(
        ...
        "UPDATE rb_system_settings SET
            ...
            no_game_message = $9,
            maintenance_enabled = $10,
            maintenance_message = $11,
            updated_by = $12,
            updated_at = CURRENT_TIMESTAMP
